...
#         return max(dp)
        ...
        # Approach: Slightly better way of building subsequence (not DP) 
        # TC: O(N^2)
        # SC: O(N)
        # But the subseq here is not the actual lis(Think of case) [7,4,5,1,8,12,4,7] which generates [1, 4, 7, 12]
